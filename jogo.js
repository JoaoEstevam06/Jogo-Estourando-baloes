...
function game_over(){
	...
	alert('Fim de jogo! Você não conseguiu estourar todos os balões a tempo! Tente outra vez :)');
}
...
function remove_eventos_baloes(){
	...
	//percorre os elementos de acordo com o id e só irá sair do laço quando não houver correspondência com elementos
